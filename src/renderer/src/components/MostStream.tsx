...
function MostStream({ setSettings, setOpenStream }: SettingsProps) {
  ...
  const handleSave = () => {
    ...
    for(const [k, v] of Object.entries(stream)) {
      parsedNumeric[k] = parseInt(String(v))
    }
    ...
    <Grid spacing={2} container sx={{ marginTop: '5%' }}>
      <Grid xs={4}>
        <TextField
          ...
          error={parseInt(String(stream.fBlockID)) !== null ? false : true}
          helperText={parseInt(String(stream.fBlockID)) !== null ? '' : 'Format must be in hex'}
        />
      </Grid>
      <Grid xs={4}>
        <TextField
          ...
          error={parseInt(String(stream.instanceID)) !== null ? false : true}
          helperText={parseInt(String(stream.instanceID)) !== null ? '' : 'Format must be in hex'}
        />
      </Grid>
      <Grid xs={4}>
        <TextField
          ...
          error={parseInt(String(stream.sinkNr)) !== null ? false : true}
          helperText={parseInt(String(stream.sinkNr)) !== null ? '' : 'Format must be in hex'}
        />
      </Grid>
      <Grid xs={6}>
        <TextField
          ...
          error={parseInt(String(stream.sourceAddrHigh)) !== null ? false : true}
          helperText={parseInt(String(stream.sourceAddrHigh)) !== null ? '' : 'Format must be in hex'}
        />
      </Grid>
      <Grid xs={6}>
        <TextField
          ...
          error={parseInt(String(stream.sourceAddrLow)) !== null ? false : true}
          helperText={parseInt(String(stream.sourceAddrLow)) !== null ? '' : 'Format must be in hex'}
        />
      </Grid>
      <Grid xs={12}>
        <Button
